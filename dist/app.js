'use strict';function _interopDefault(e){return(e&&(typeof e==='object')&&'default'in e)?e['default']:e}var React=_interopDefault(require('react')),stream=_interopDefault(require('stream')),styled=require('styled-components'),styled__default=_interopDefault(styled);var commonjsGlobal = typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {};
...
var App = function App(_a) {
  var state = _a.state;
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Wrapper, null, "It, work styled component5"));
};
var templateObject_1;var GLOBAL_STATE = {};
var sheet = new styled.ServerStyleSheet();
var jsx = sheet.collectStyles( /*#__PURE__*/React.createElement(App, {
  state: GLOBAL_STATE
}));
var bodyStream = sheet.interleaveWithNodeStream(server.renderToNodeStream(jsx));module.exports=bodyStream;//# sourceMappingURL=app.js.map
