...
contentDisposition_1.parse = parse_1$3;var inherits_browser$1 = createCommonjsModule(function (module) {
if (typeof Object.create === 'function') {
  // implementation from standard node.js 'util' module
  module.exports = function inherits(ctor, superCtor) {
    if (superCtor) {
...
serveStatic_1.mime = mime$2;var express = createCommonjsModule(function (module, exports) {
/*!
 * express
 * Copyright(c) 2009-2013 TJ Holowaychuk
 * Copyright(c) 2013 Roman Shtylman
...
function _wrapRegExp(re, groups) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, "Select a Language");
  ...
  return /*#__PURE__*/React__default.createElement("ul", {
  ...
  }, repos.map(function (_a) {
    var name = _a.name,
        owner = _a.owner,
        stargazers_count = _a.stargazers_count,
        html_url = _a.html_url;
    return /*#__PURE__*/React__default.createElement("li", {
      ...
      href: html_url
    }, name)), /*#__PURE__*/React__default.createElement("li", null, "@", owner.login), /*#__PURE__*/React__default.createElement("li", null, stargazers_count, " stars")));
  }));
};var fetchPopularRepos = function fetchPopularRepos(language) {
  if (language === void 0) {
    language = 'all';
  }

  return __awaiter(void 0, void 0, void 0, function () {
    var encodedURI, data, repos, error_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
...
var Counter = function Counter() {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(Wrapper, null, /*#__PURE__*/React__default.createElement("p", null, counter), /*#__PURE__*/React__default.createElement("button", {
    type: "button",
...
var templateObject_1;/** MobX - (c) Michel Weststrate 2015 - 2020 - MIT Licensed */
/*! *****************************************************************************
Copyright (c) Microsoft Corporation. All rights reserved.
Licensed under the Apache License, Version 2.0 (the "License"); you may not use
this file except in compliance with the License. You may obtain a copy of the
...
function whenPromise(predicate, opts) {
    ...
    var res = new Promise(function (resolve, reject) {
        var disposer = _when(predicate, resolve, __assign$1(__assign$1({}, opts), { onError: reject }));
        cancel = function () {
            disposer();
...
function useAsObservableSourceInternal(current, usedByLocalStore) {
  ...
  if (process.env.NODE_ENV !== "production" && !isPlainObject$1(current)) {
...
function copyStaticProperties$1(base, target) {
  ...
  Object.getOwnPropertyNames(base).forEach(function (key) {
    if (!hoistBlackList$1[key] && protoProps.indexOf(key) === -1) {
      Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(base, key));
    }
  });
}
...
function Provider(props) {
  var children = props.children,
      stores = _objectWithoutPropertiesLoose$1(props, ["children"]);

  var parentValue = React__default.useContext(MobXProviderContext);
  var mutableProviderRef = React__default.useRef(_extends$2({}, parentValue, {}, stores));
  var value = mutableProviderRef.current;

  if (process.env.NODE_ENV !== "production") {
    var newValue = _extends$2({}, value, {}, stores); // spread in previous state for the context based stores
...
function createStoreInjector(grabStoresFn, component, injectNames, makeReactive) {
  ...
  copyStaticProperties$1(component, Injector);
...
if (!observable) throw new Error("mobx-react requires mobx to be available");var CounterView =
/** @class */
function (_super) {
  ...
  CounterView.prototype.render = function () {
    ...
    var model = this.props.model; // just some HTML markup based of the ViewModel data.

    return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("h1", null, "React Counter with MVVM!"), /*#__PURE__*/React__default.createElement("p", null, /*#__PURE__*/React__default.createElement("button", {
      type: "button",
      onClick: function onClick() {
    ...
    }, "Minus")), /*#__PURE__*/React__default.createElement("h1", null, "Count: ", model.showNumber), /*#__PURE__*/React__default.createElement("h1", null, "Count1: ", model.getNumber()));
  };

  CounterView = __decorate([observer$1], CounterView);
  return CounterView;
}(React__default.Component);var _nextId = 0;
...
function () {
  function CounterModel() {
    this.number = 0; //Action ile değiştirilebilir.
  }

  __decorate([observable], CounterModel.prototype, "number", void 0);

  return CounterModel;
}();var number = new CounterModel();

var CounterViewModel =
/** @class */
function () {
  function CounterViewModel() {
    ...
    //     return newTodo
    // }
    this.showNumber = 0; // load saved todos, if possible
  ...
  CounterViewModel.prototype.getNumber = function () {
    return number.number;
  };

  __decorate([observable], CounterViewModel.prototype, "showNumber", void 0);

  __decorate([action], CounterViewModel.prototype, "increase", null);

  __decorate([action], CounterViewModel.prototype, "decrease", null);

  __decorate([action], CounterViewModel.prototype, "getNumber", null);
...
var routes = [{
  ...
  return /*#__PURE__*/React__default.createElement("ul", null, languages.map(function (_a) {
    var name = _a.name,
        param = _a.param;
    return /*#__PURE__*/React__default.createElement("li", {
      key: param
  ...
  }), /*#__PURE__*/React__default.createElement("li", null, /*#__PURE__*/React__default.createElement(reactRouterDom.NavLink, {
    activeStyle: {
      fontWeight: 'bold'
    },
    to: "/counterMVVM"
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Navbar, null), /*#__PURE__*/React__default.createElement(reactRouterDom.Switch, null, routes.map(function (_a) {
    var path = _a.path,
        exact = _a.exact,
        Component = _a.component,
        rest = __rest(_a, ["path", "exact", "component"]);
    ...
    return /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
      ...
      render: function render(props) {
        return /*#__PURE__*/React__default.createElement(Component, _extends({}, props, rest));
      }
    });
...
isProd ? app.get(paths, function (req, res, next) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    var activeRoute, data, _a, context, sheet, markup, bodyStream;
